...
producer_thread = multiprocessing.Process(target=producer, args=(shared_queue, condition))
consumer_thread = multiprocessing.Process(target=consumer, args=(shared_queue, condition))
